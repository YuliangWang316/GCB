...
for (t in 5:50) {
  for (u in c(50,100,200,300,400,500,600,700,800,900,1000)) {
    for (v in c(20,30,40,50,60,70,80,90,100)) {
      for (w in seq(0.5,10,by=0.1)) {
            ...
            if(levels(Kdm6b$ident)[1] == levels(Myc$ident)[1]){
              ...
              if (levels(Myc$ident)[1] == levels(MTOR_1$ident)[1]){
                if (levels(Myc$ident)[1] == levels(GLUTAMINE_1$ident)[1]){
                  ...
                  if (c >= 0.5 & f >=0.5 & r>=0.5 & l >=0.5 & o >=0.5 ){
