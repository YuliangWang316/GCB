...
monocle_cds <- reduceDimension(monocle_cds, max_components = 3, num_dim = 9,
                               reduction_method = 'tSNE', verbose = T)
monocle_cds_1 <- reduceDimension(monocle_cds, max_components = 3, num_dim = 9,
                                 reduction_method = 'DDRTree', verbose = T)
monocle_cds_2 <- reduceDimension(monocle_cds, max_components = 3,
                                 reduction_method = 'ICA', verbose = T)
#monocle_cds_3 <- reduceDimension(monocle_cds, max_components = 3,
#                                 reduction_method = 'SimplePPT',num_dim = 9, verbose = T)
#monocle_cds_4 <- reduceDimension(monocle_cds, max_components = 3,
#                                 reduction_method = 'L1-graph',num_dim = 9, verbose = T)
#monocle_cds_5 <- reduceDimension(monocle_cds, max_components = 3,
#                                 reduction_method = 'SGL-tree',num_dim = 9, verbose = T)
#monocle_cds_6 <- reduceDimension(monocle_cds, max_components = 3, num_dim = 9,
#                                 reduction_method = 'tSNE', verbose = T,norm_method = '')
#monocle_cds_3 <- clusterCells(monocle_cds, num_clusters = 20)
#plot_cell_clusters(monocle_cds_3, 2, 3, color = "CellType",
#                   markers = c("Myc", "Irf4","Kdm6b","Ly75"))
#monocle_cds_4<-clusterCells(monocle_cds,num_clusters = 20,clustering_genes = c("Myc","Irf4"))
#plot_cell_clusters(monocle_cds_4, 2, 3, color = "CellType",
#                   markers = c("Myc", "Irf4","Kdm6b","Ly75"))
#monocle_cds_5<-clusterCells(monocle_cds_1,num_clusters = 20,clustering_genes = c("Myc","Irf4"))
#plot_cell_clusters(monocle_cds_5, 1, 2, color = "CellType",
#                   markers = c("Myc", "Irf4","Kdm6b","Ly75"))
